...
"[project]/node_modules/highcharts/highcharts.js [client] (ecmascript)": (function(__turbopack_context__) {
 ...
 - ${i}: ${e}`, r && (a += encodeURI(i) + "=" + encodeURI(e));
        ...
        class iU {
            ...
            shadowDefinition(t) {
                ...
                ].join("-").toLowerCase().replace(/[^a-z\d\-]/g, ""), i = iF({
                    color: "#000000",
                    offsetX: 1,
                    offsetY: 1,
                    opacity: .15,
            ...
            fontMetrics(t) {
                let e = iG(eJ.prototype.getStyle.call(t, "font-size") || 0), i = e < 24 ? e + 3 : Math.round(1.2 * e), s = Math.round(.8 * i);
                return {
                    h: i,
                    b: s,
                    f: e
                ...
                if (e || i_(t, {
                    ...
                    if (p !== i) {
                        let e = this.textPxLength ? this.textPxLength : (i_(t, {
                            width: "",
                            whiteSpace: d || "nowrap"
                        }), t.offsetWidth), s = p || 0, r = "" === t.style.textOverflow && t.style.webkitLineClamp;
        ...
        class s$ {
                ...
                sE(this, "getSeriesExtremes", null, function() {
                    e.hasVisibleSeries = !1, e.dataMin = e.dataMax = e.threshold = void 0, e.softThreshold = !e.isXAxis, e.series.forEach((i)=>{
                        if (i.reserveSpace()) {
                            ...
                            if (e.hasVisibleSeries = !0, e.positiveValuesOnly && 0 >= (r || 0) && (r = void 0), e.isXAxis) (o = i.getColumn("x")).length && (o = e.logarithmic ? o.filter((t)=>t > 0) : o, a = (t = i.getXExtremes(o)).min, n = t.max, sN(a) || a instanceof Date || (o = o.filter(sN), a = (t = i.getXExtremes(o)).min, n = t.max), o.length && (e.dataMin = Math.min(sF(e.dataMin, a), a), e.dataMax = Math.max(sF(e.dataMax, n), n)));
                            else {
                                let t = i.applyExtremes();
                                sN(t.dataMin) && (a = t.dataMin, e.dataMin = Math.min(sF(e.dataMin, a), a)), sN(t.dataMax) && (n = t.dataMax, e.dataMax = Math.max(sF(e.dataMax, n), n)), sC(r) && (e.threshold = r), (!s.softThreshold || e.positiveValuesOnly) && (e.softThreshold = !1);
                            }
                        }
                    });
            ...
            getPlotLinePath(t) {
                ...
                return sE(this, "getPlotLinePath", b, function(t) {
                    g = f = (c = sS(c = sF(c, e.translate(a, void 0, void 0, r)), -1e9, 1e9)) + d, u = m = h - c - d, sN(c) ? e.horiz ? (u = o, m = h - e.bottom + (e.options.isInternal ? 0 : i.scrollablePixelsY || 0), g = f = y(g, s, s + e.width)) : (g = s, f = l - e.right + (i.scrollablePixelsX || 0), u = m = y(u, o, o + e.height)) : (x = !0, p = !1), t.path = x && !p ? void 0 : i.renderer.crispLine([
                        [
                            "M",
                            g,
                            u
            ...
            nameToX(t) {
                ...
                return t.series.requireSorting = !1, sC(s) || (s = this.uniqueNames && i ? e ? i.indexOf(t.name) : sF(i.keys[t.name], -1) : t.series.autoIncrement()), -1 === s ? !e && i && (o = i.length) : sN(s) && (o = s), void 0 !== o ? (this.names[o] = t.name, this.names.keys[t.name] = o) : t.x && (o = t.x), o;
            }
            updateNames() {
            ...
            setAxisTranslation() {
                ...
                (o || s || r) && (a = t.getClosest(), i ? (n = i.minPointOffset, h = i.pointRangePadding) : t.series.forEach(function(e) {
                    let i = s ? 1 : o ? sF(e.options.pointRange, a, 0) : t.axisPointRange || 0, l = e.options.pointPlacement;
            ...
            setAxisSize() {
                let t = this.chart, e = this.options, i = e.offsets || [
                    ...
                    0,
                    0
                ], s = this.horiz, o = this.width = Math.round(sX(sF(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth)), r = this.height = Math.round(sX(sF(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight)), a = this.top = Math.round(sX(sF(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop)), n = this.left = Math.round(sX(sF(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft));
            ...
            autoLabelAlign(t) {
                let e = (sF(t, 0) - 90 * this.side + 720) % 360, i = {
                    align: "center"
                };
            ...
            getOffset() {
                ...
                }), d?.text && !1 !== d.enabled && (t.addTitle(m), m && !p && !1 !== d.reserveSpace && (t.titleOffset = x = t.axisTitle.getBBox()[i ? "height" : "width"], b = sC(y = d.offset) ? 0 : sF(d.margin, i ? 5 : 10))), t.renderLine(), t.offset = f * sF(s.offset, g[o] ? g[o] + (s.margin || 0) : 0), t.tickRotCorr = t.tickRotCorr || {
                    x: 0,
                    y: 0
            ...
            update(t, e) {
                let i = this.chart;
                t = sR(this.userOptions, t), this.destroy(!0), this.init(i, t), i.isDirtyBox = !0, sF(e, !0) && i.redraw();
            }
            remove(t) {
                let e = this.chart, i = this.coll, s = this.series, o = s.length;
                for(; o--;)s[o] && s[o].remove(!1);
                sP(e.axes, this), sP(e[i] || [], this), e.orderItems(i), this.destroy(), e.isDirtyBox = !0, sF(t, !0) && e.redraw();
            }
            setTitle(t, e) {
                this.update({
                    title: t
        ...
        class oq {
            ...
            optionsToObject(t) {
                ...
                else if (oX(t)) for(!i && t.length > o && ("string" == (a = typeof t[0]) ? e.xAxis?.dateTime ? r.x = e.chart.time.parse(t[0]) : r.name = t[0] : "number" === a && (r.x = t[0]), n++); h < o;)i && void 0 === t[n] || (s[h].indexOf(".") > 0 ? oq.prototype.setNestedProperty(r, t[n], s[h]) : r[s[h]] = t[n]), n++, h++;
        ...
        class rr {
            ...
            touch(t, e) {
                ...
                this.setHoverChartIndex(), 1 === (t = this.normalize(t)).touches.length ? s.isInsidePlot(t.chartX - s.plotLeft, t.chartY - s.plotTop, {
                    visiblePlotOnly: !0
                }) && !s.exporting?.openMenu ? (e && this.runPointActions(t), "touchmove" === t.type && (i = !!o[0] && Math.pow(o[0].chartX - t.chartX, 2) + Math.pow(o[0].chartY - t.chartY, 2) >= 16), ri(i, !0) && this.pinch(t)) : e && this.reset() : 2 === t.touches.length && this.pinch(t);
            }
            touchSelect(t) {
        ...
        class r0 {
            ...
            update(t, e) {
                ...
                g = g || r, u ? (p.push.apply(p, r0.keepPropsForPoints), !1 !== t.visible && p.push("area", "graph"), i.parallelArrays.forEach(function(t) {
                    p.push(t + "Data");
                }), t.data && (t.dataSorting && rF(i.options.dataSorting, t.dataSorting), this.setData(t.data, !1))) : this.dataTable.modified = this.dataTable, t = r_(o, {
            ...
            adjustMargins(t, e) {
                ...
                o && [
                    ...
                    r.test(o) && !ai(t[a]) && (i[r9[a]] = Math.max(i[r9[a]], i.legend[(a + 1) % 2 ? "legendHeight" : "legendWidth"] + [
                        ...
                        -1,
                        1
                    ][a] * s[a % 2 ? "x" : "y"] + ah(s.margin, 12) + e[a] + (i.titleOffset[a] || 0)));
                });
            }
            proximatePositions() {
        ...
        class a0 {
            ...
            temporaryDisplay(t) {
                ...
                else for(; e?.style && (aw.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0, aw.body.appendChild(e)), ("none" === aF(e, "display", !1) || e.hcOricDetached) && (e.hcOrigStyle = {
            ...
            transform(t) {
                ...
                for (let t of e){
                    ...
                    let { dataMin: E, dataMax: I, min: D, max: B } = az(t.getExtremes(), O || {}), N = l.parse(f.min), z = l.parse(f.max), R = E ?? N, W = I ?? z, H = L - P, F = t.categories ? 0 : Math.min(H, W - R), X = R - F * (aE(N) ? 0 : f.minPadding), G = W + F * (aE(z) ? 0 : f.maxPadding), j = t.allowZoomOutside || 1 === k || "zoom" !== n && k > 1, Y = Math.min(N ?? X, X, j ? D : X), U = Math.max(z ?? G, G, j ? B : G);
        ...
        class ni {
            ...
            static afterSetSize(t, e) {
                ...
                if (!d.forExport && (r ? (t.scrollablePixelsX = i = Math.max(0, r - t.chartWidth), i && (t.scrollablePlotBox = a8(t.plotBox), h.width = t.plotWidth += i, n[l ? "height" : "width"] += i, o = !0)) : a && (t.scrollablePixelsY = s = Math.max(0, a - t.chartHeight), a9(s) && (t.scrollablePlotBox = a8(t.plotBox), h.height = t.plotHeight += s, n[l ? "width" : "height"] += s, o = !1)), a9(o) && !e.skipAxes)) for (let e of t.axes)(e.horiz === o || t.hasParallelCoordinates && "yAxis" === e.coll) && (e.setAxisSize(), e.setAxisTranslation());
            }
            constructor(t){
        ...
        class hj extends oK {
            ...
            slice(t, e, i) {
                let s = this.series;
                hz(i, s.chart), e = hX(e, !0), this.sliced = this.options.sliced = t = hW(t) ? t : !this.sliced, s.options.data[s.data.indexOf(this)] = this.options, this.graphic && this.graphic.animate(this.getTranslate());
            }
        }
        hH(hj.prototype, {
            connectorShapes: {
            ...
            function s() {
                ...
                t.visible && t.hasDataLabels?.() && (e.forEach((t)=>{
                    ...
                    (t.dataLabels || []).forEach((e, i)=>{
                        let s = n[2] / 2, o = e.options, r = h4(o?.distance || 0, s);
                        ...
                        (i.dataLabels || []).forEach((l)=>{
                            ...
                            if (x) {
                                ...
                                if (x.attribs = {
                                    ...
                                    y: M + (d.y || 0) - v / 2
                                }, x.computed.x = w, x.computed.y = M - k, h6(d.crop, !0)) {
                                    let t;
            ...
            for(let i = 0; i < e; i++)(o = t[i]) && (o.oldOpacity = o.opacity, o.newOpacity = 1, o.absoluteBox = function(t) {
                if (t && (!t.alignAttr || t.placed)) {
                    let e = t.box ? 0 : t.padding || 0, i = t.alignAttr || {
                        x: t.attr("x"),
                        y: t.attr("y")
                    }, { height: s, polygon: o, width: r } = t.getBBox(), a = le(t.alignValue) * r;
        ...
        }, { defaultOptions: ll } = tv, { noop: ld } = w, { addEvent: lc, extend: lp, isObject: lg, merge: lu, relativeLength: lf } = V, lm = {
            radius: 0,
            scope: "stack",
            where: void 0
        }, lx = ld, ly = ld;
        function lb(t, e, i, s, o = {}) {
            let r = lx(t, e, i, s, o), { innerR: a = 0, r: n = i, start: h = 0, end: l = 0 } = o;
            if (o.open || !o.borderRadius) return r;
            let d = l - h, c = Math.sin(d / 2), p = Math.max(Math.min(lf(o.borderRadius || 0, n - a), (n - a) / 2, n * c / (1 + c)), 0), g = Math.min(p, d / Math.PI * 2 * a), u = r.length - 1;
        ...
        function lv() {
            if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
                let { options: t, yAxis: e } = this, i = "percent" === t.stacking, s = ll.plotOptions?.[this.type]?.borderRadius, o = lk(t.borderRadius, lg(s) ? s : {}), r = e.options.reversed;
        ...
        function lM(t, e, i, s, o = {}) {
            let r = ly(t, e, i, s, o), { r: a = 0, brBoxHeight: n = s, brBoxY: h = e } = o, l = e - h, d = h + n - (e + s), c = l - a > -.1 ? 0 : a, p = d - a > -.1 ? 0 : a, g = Math.max(c && l, 0), u = Math.max(p && d, 0), f = [
                t + c,
                e
            ], m = [
                t + i - c,
        ...
        !function(t) {
            ...
            function i(t, e) {
                ...
                let n = s?.ruleIds;
                o !== n && (s && (this.currentResponsive = void 0, this.updatingResponsive = !0, this.update(s.undoOptions, t, !0), this.updatingResponsive = !1), o ? ((r = lS(a, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0, this.currentResponsive = {
                    ruleIds: o,
                    mergedOptions: a,
                    undoOptions: r
