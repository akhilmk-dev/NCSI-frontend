 ...
 var chart = new Highcharts.Chart({
      ...
      function DrawPeiChart() {
          try {
              ...
              //     alert(window.myPie)
              var Flag;
              var lcid = 1033//_spPageContextInfo.currentLanguage;
              if (lcid == 1033) {
                  Flag = {
      ...
      function RunClock() {
          var selectedDateText = $('.date-select .popup').find('div.month').find('span.num').text() + '/' + $('.date-select .popup').find('div.day').find('span.num').text() + '/' + $('.date-select .popup').find('div.year').find('span.num').text();
